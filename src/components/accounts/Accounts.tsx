...
import { Badge, Button, Col, Collapse, Form, InputGroup, Row, Table } from "react-bootstrap";
...
export default class Accounts extends React.Component<AccountsProps, AccountsState> {
							...
							return (
								<tr key={account.id}>
									...
									<td className={"text-end"}>
										{amountFormatter.format(account.balance)}
									</td>
								</tr>
							);
						})}
